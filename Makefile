...
# phase 3
kernel : ./phase3/deviceMutex.o ./phase3/initProc.o ./phase3/vmSupport.o ./phase3/sysSupport.o ./phase3/sst.o ./phase2/initial.o ./phase2/scheduler.o ./phase2/exceptions.o ./phase2/ssi.o ./phase2/interrupts.o ./phase2/klog.o ./phase1/msg.o ./phase1/pcb.o crtso.o libumps.o
	$(LD) -o $@ $^ $(LDFLAGS)
